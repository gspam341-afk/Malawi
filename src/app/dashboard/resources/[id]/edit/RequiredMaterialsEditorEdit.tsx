...
export function RequiredMaterialsEditorEdit(props: { initialItems: RequiredMaterialDraft[] }) {
  const [items, setItems] = useState<RequiredMaterialDraft[]>(props.initialItems)
    ...
    <div className="mt-4 grid gap-4">
      ...
      <div className="grid gap-3">
        {items.length ? (
          ...
          <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 text-sm text-zinc-700">No materials added.</div>
        )}
      </div>
