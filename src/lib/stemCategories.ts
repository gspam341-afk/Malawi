...
export const STEM_CATEGORIES: Record<StemSlug, StemCategoryMeta> = {
  science: {
    ...
    description: 'Explore Physics, Chemistry and Biology as core school subjects through practical activities.',
    studentDescription:
  ...
  technology: {
    ...
    title: 'Technology',
    subjects: [],
    description: 'Technology subject content is planned for a future version.',
  ...
  engineering: {
    ...
    description: 'Explore Agriculture as a school subject through hands-on, real-world activities.',
  ...
  mathematics: {
    ...
    description: 'Explore Mathematics as a school subject through printable, physical and problem-solving activities.',
